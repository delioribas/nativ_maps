...
void main() {
  ...
  late CompassMaps maps;

  setUp(() {
    service = FakeAlsService();
    maps = fakeCompassMaps(service);
  });
  ...
  group('los errores salen donde se pueden corregir', () {
    ...
    test('una clave vacía falla antes de la red, con mensaje claro', () async {
      final sinClave = fakeCompassMaps(
        service,
      ...
      expect(
        ...
        throwsA(isA<CompassMapsConfigurationException>()),
      );
      expect(service.requests, isEmpty);
    });
  });
