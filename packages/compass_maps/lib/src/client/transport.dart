...
import 'package:compass_maps/src/core/exceptions.dart';
...
class TransportOptions {
  ...
  const TransportOptions({
    ...
    this.userAgent = 'compass-maps-dart/0.1.0',
  });
...
class AlsTransport {
  ...
  /// `compass_maps_sigv4`. Intentarlo con clave da un `403` que se parece a
  ...
  void _ensureAuthSupported(String operation, AlsService service) {
    ...
    throw CompassMapsConfigurationException(
      ...
      '(ProxyCredentials) o el paquete compass_maps_sigv4.',
    );
  }
  ...
  void _ensureConfigured(String operation) {
    if (_closed) {
      throw StateError(
        'El cliente de Compass Maps ya se cerró. Llamar a $operation después '
